...
def return_NN_solution(shock_expo, seed, chiUnderline, a_e, a_h, gamma_e, gamma_h, psi_e, psi_h, delta_e, delta_h, lambda_d, nu,n_layers,units,iter_num, points_size,penalization, action_name):
        ...
        outputdir = 'output/' + action_name + '/' + shock_expo + '/'+ domain_folder + '/' + model_folder + '/' + layer_folder + '/'
...
def return_sim_elasticity(shock_expo, seed, chiUnderline, a_e, a_h, gamma_e, gamma_h, psi_e, psi_h, delta_e, delta_h, lambda_d, nu,n_layers,units,iter_num, points_size,penalization, action_name, W_percentile, Z_percentile, V_percentile):
        ...
        elasticity = np.load(outputdir + 'elasticities_W_'+ str(W_percentile) + 'Z_' + str(Z_percentile) + 'V_' + str(V_percentile)+'.npz', allow_pickle=True)
