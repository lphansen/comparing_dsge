...
def main_var(action_name, nWealth, nZ, nV, V_bar, sigma_K_norm, sigma_Z_norm, sigma_V_norm, wMin, wMax, chiUnderline, a_e, a_h, gamma_e, gamma_h, rho_e, rho_h, delta_e, delta_h, lambda_d, nu, shock_expo, n_layers, units, points_size, iter_num, seed, penalization, BFGS_maxiter, BFGS_maxfun):
    ...
    dent_NN = dump_variables(sim_NN_tf, params, nWealth, nZ, nV, outputdir)

    ## Compute and save marginal quantiles
    compute_and_save_quantiles(sim_NN_tf, params, nWealth, nZ, nV, outputdir,dent_NN)
...
def compute_and_save_quantiles(sim_NN_tf, params, nWealth, nZ, nV, outputdir,dent_NN):
    W_NN = np.linspace(params['wMin'], params['wMax'], num=nWealth)
    ...
    compute_and_save_evaluation(sim_NN_tf, params, marginal_quantile, W_NN, outputdir)

def compute_and_save_evaluation(sim_NN_tf, params, marginal_quantile, W_NN, outputdir):
    num = 1800
