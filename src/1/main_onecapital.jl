...
# Main function encapsulating all the logic
function main(gamma, rho, Delta, delta, alpha, action_name)
...
if abspath(PROGRAM_FILE) == @__FILE__
    ...
    main(parsed_args["gamma"], parsed_args["rho"], parsed_args["Delta"], parsed_args["delta"], parsed_args["alpha"], parsed_args["action_name"])
end
