...
#### default parameters set to make it 3D.
params['nV']           = 20
params['nZ']           = 20
params['nWealth']      = 50
...
#### You only need to input the cov(2,1), cov(3,1) and cov(3,2) as the program will automatically
#### compute other covs. By default, cov(i,j) = 1 for j = i and cov(i,j) = 0 for all j > i.
